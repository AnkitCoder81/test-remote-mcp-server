...
#         Args:
#            min_val:Minimum number (default:1)
#            max_val:Maximum number (default:100)
...
#         mcp.run(transport="http",host="0.0.0.0",port=8000)  #host="0.0.0.0" -> means we are ready to take any IP address
